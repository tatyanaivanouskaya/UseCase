...
Hi everyone. This is a small project where I've tried to use Clean Architecture, MVVM, Koin, Dagger (dagger branch), Hilt (hilt branch), JUnit testing (master branch).
